...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/algobotmanager_x86

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/algobotmanager_x86: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/algobotmanager_x86 ${OBJECTFILES} ${LDLIBSOPTIONS} -pthread
